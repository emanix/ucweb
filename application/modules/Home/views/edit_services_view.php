                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="form-line">
                              ...
                              <input type="text" class="form-control" name="servicehead" value="<?php echo $servicehead; ?>">
                            ...
                            <div class="body">
                              <div class="row clearfix">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <div class="form-line">
                                      <textarea rows="8" class="form-control no-resize" name="service"><?php echo $service; ?></textarea>
                                    </div>
                                  </div>
                                </div>
                              </div>
