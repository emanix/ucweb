	...
	<footer>
			...
			<div class="row py-xl-5 py-sm-3">
				...
				<div class="col-lg-6 contact-agileits-w3layouts mt-lg-0 mt-4">
					...
					<p class="para-agileits-w3layouts text-white my-sm-3 my-2">
						<i class="fas fa-phone pr-3"></i><?php echo $phone1; ?></p>
					<p class="para-agileits-w3layouts">
						<i class="far fa-envelope-open pr-2"></i>
						<a href="mailto:mail@example.com" class=" text-white"><?php echo $email; ?></a>
					</p>
				</div>
			</div>
		</div>
		<div class="copyright-agiles py-3">
			<div class="container">
				<div class="row">
					<p class="col-lg-8 copy-right-grids text-white text-lg-left text-center mt-lg-1">© 2018 IITAS. All Rights Reserved | Design by
						<a href="<?php echo base_url(); ?>" target="_blank">EmanixWeb Consult</a>
					</p>
					<!-- social icons -->
	...
	<!-- Js files -->
	<!-- JavaScript -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/jquery-2.2.3.min.js"></script>
	<!-- Default-JavaScript-File -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/bootstrap.js"></script>
	<!-- Necessary-JavaScript-File-For-Bootstrap -->

	<!-- banner slider -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/slider.js"></script>
	<!-- //banner slider -->

	<!-- testimonial-plugin -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/mislider.js"></script>
	<script>
		jQuery(function ($) {
	...
	<!-- numscroller-js-file -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/numscroller-1.0.js"></script>
	<!-- //numscroller-js-file -->

	<!-- smooth scrolling -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/SmoothScroll.min.js"></script>
	<!-- //smooth scrolling -->

	<!-- move-top -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/move-top.js"></script>
	<!-- easing -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/easing.js"></script>
	<!--  necessary snippets for few javascript files -->
	<script src="<?php echo base_url(); ?>asset/cweb/js/edulearn.js"></script>
