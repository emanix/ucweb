					...
					<div class="col-lg-8 right-info-agiles mt-lg-0 mt-sm-3 mt-1">
						<div class="row">
							<div class="col-sm-3 nav-middle">
								<i class="far fa-envelope-open text-center mr-md-2 mr-sm-1 mr-2"></i>
							...
							<div class="col-sm-3 col-6 nav-middle mt-sm-0 mt-2">
								<i class="fas fa-phone-volume text-center mr-md-2 mr-sm-1 mr-2"></i>
								<div class="agile-addresmk">
									<p>
							...
							<div class="col-sm-3 col-6 top-login-butt text-right mt-sm-2">
								<a href="<?php echo base_url(); ?>Login" class="button-head-mow3 text-white">Signup</a>
							</div>
						</div>
					</div>
				</div>
