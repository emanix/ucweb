					...
					<ul class="navbar-nav justify-content-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="<?php echo base_url(); ?>Services/evaluation_services">Services
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item active" href="<?php echo base_url(); ?>Services/translation_services/">Services</a>
